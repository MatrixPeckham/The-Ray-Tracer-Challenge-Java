...
public class TupleTest {
    ...
    public void tupleW1IsPoint() {
        ...
        assertThat(t.x, is(4.3));
        assertThat(t.y, is(-4.2));
        assertThat(t.z, is(3.1));
        assertThat(t.w, is(1.0));
        assertThat(t.isPoint(), is(true));
        assertThat(t.isVector(), is(false));
    }
    ...
    public void tupleW0IsVector() {
        ...
        assertThat(t.y, is(-4.2));
        assertThat(t.z, is(3.1));
        assertThat(t.w, is(0.0));
        assertThat(t.isPoint(), is(false));
        assertThat(t.isVector(), is(true));
    }

    @Test
    public void pointMakesPoint() {
        Tuple t = Point(4, -4, 3);
        assertThat(t.x, is(4.0));
        assertThat(t.y, is(-4.0));
        assertThat(t.z, is(3.0));
        assertThat(t.w, is(1.0));
        assertThat(t.isPoint(), is(true));
        assertThat(t.isVector(), is(false));
    }
    ...
    public void addingTuples() {
        ...
        assertThat(t4.isPoint(), is(true));
        t = new Tuple(6, -1, 4, 0);
        t2 = new Tuple(-2, 3, 1, 0);
        t3 = t.add(t2);
        t4 = new Tuple(4, 2, 5, 0);
        assertThat(t4.equals(t3), is(true));
        assertThat(t4.isVector(), is(true));
    }
    ...
    public void subtractingPoints() {
        ...
        assertThat(t4.equals(t3), is(true));
        assertThat(t3.isVector(), is(true));
    }
    ...
    public void normalizes() {
        ...
        Tuple r = t.normalize();
        assertThat(r.equals(Vector(1, 0, 0)), is(true));
        t = Vector(1, 2, 3);
        r = t.normalize();
        ...
        assertThat(t.normalize().equals(Tuple.normalize(t)), is(true));
    }
    ...
    public void cross() {
        ...
        assertThat(Tuple.cross(a, b).equals(ab), is(true));
        assertThat(Tuple.cross(b, a).equals(ba), is(true));
    }
